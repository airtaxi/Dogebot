...
public class HelpCommandHandler(ILogger<HelpCommandHandler> logger) : ICommandHandler
{
    ...
    [
        new("🎮 게임 & 랜덤", ["게임", "랜덤"], [new("!홀 / !짝", ["!홀", "!짝"], "홀짝 게임"), new("!주사위 (범위)", ["!주사위"], "1~범위 사이 랜덤 숫자 (최대: 2,147,483,647)"), new("확률", ["확률"], "0~100% 랜덤 확률"), new("!선택 (항목1) (항목2) ...", ["!선택"], "랜덤 선택"), new("!뭐먹지", ["!뭐먹지"], "음식 추천"), new("!코스요리", ["!코스요리"], "랜덤 코스요리 추천"), new("!차뽑기", ["!차뽑기"], "랜덤 차량 뽑기"), new("!행성뽑기", ["!행성뽑기"], "노 맨즈 스카이 랜덤 행성 생성"), new("!로또 [회차 수]", ["!로또"], "로또 번호 생성 (최대 10회)"), new("!운세", ["!운세"], "오늘의 운세 (재물운, 성공운, 애정운)")]),
        ...
        new("🤖 AI", ["AI", "댕댕아"], [new("댕댕아 (메시지)", ["댕댕아"], "AI 댕댕이 답변")]),
